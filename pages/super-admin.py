                    ...
                    with tempfile.TemporaryDirectory() as temp_dir:
                        for uploaded_file in uploaded_files:
                            ...
                            if temp_image_path:
                                ...
                                similar_prompt_template = 'Create similar prompts based on the image. Ensure the prompts are varied and result in popular images on photostock, especially on Adobe Stock.'
