...
def generate_description(model, img):
    description = model.generate_content(["Create four effective prompts in detailed based on the photo in SEO terms to make it easier for buyers to find this image on the microstock site .", img])
