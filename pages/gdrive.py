...
def generate_metadata(model, img):
    ...
    tags = model.generate_content(["Generate up to 49 keywords in English that are relevant to the image (each keyword must be one word, separated by commas). Ensure each keyword is a single word, separated by commas.", img])
