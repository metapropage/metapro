...
def generate_metadata(model, img):
    caption = model.generate_content(["As the helpful Digital Asset Metadata Manager, analyze the following image and generate search engine optimized titles for stock photography. Create a descriptive title in English, up to 12 words long, that identifies the main elements of the image. Highlight the primary subjects, objects, activities, and context.  Avoid mentioning human names, brand names, product names, or company names.", img])
